...
Serial.println("NEMESIS F1 is ready to rock"); //begining statement because i can :P
delay(1000);
} 
...
void MoveF()
{
    ...
    if (ir11 == HIGH )
    {
        Serial.println("NEMESIS F1 Forward");
        ...
        Serial.println("NEMESIS F1 forward obstacle");
    } 
}
...
void MoveB()
{
    ...
    if (ir13 == HIGH )
    {
        Serial.println("NEMESIS F1 Backward");
        ...
        Serial.println("NEMESIS F1 backward obstacle");
    }
}
...
void MoveL()
{
    ...
    if (ir14 == HIGH )
    {
        Serial.println("NEMESIS F1 Left");
        ...
        Serial.println("NEMESIS F1 Leftside obstacle");
    }
...
void MoveR()
{
    ...
    if (ir12 == HIGH )
        {  
            Serial.println("NEMESIS F1 Right");
        ...
        Serial.println("NEMESIS F1 Rightside obstacle");
    }
...
void Stop()
{
    Serial.println("NEMESIS F1 Stop");
    digitalWrite(Lmotor1,LOW);//Writing a digital LOW to all pins associated with movement of motor driver causes all motors to stop
    digitalWrite(Lmotor2,LOW);
    digitalWrite(Rmotor1,LOW);
    digitalWrite(Rmotor2,LOW);
